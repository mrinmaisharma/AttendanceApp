                ...
                <div class="card-body">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-12 text-center">
                            <a href="/master/<?php echo e($master['id']); ?>/edit" class="btn btn-danger px-5">Edit Profile</a>
                        </div>
                    </div>
                </div>
            </div>  
            ...
            <div class="card">
                <div class="card-body">
                    <form action="/change/password" method="post">
                        ...
                        <input type="hidden" name="username" value="<?php echo e($master['username']); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                title="UpperCase, LowerCase, Number/SpecialChar and min 6 Chars." minlength="6" class="form-control" name="oldPassword" required placeholder="Enter your current password.">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="password" pattern="((?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$)"
                                title="UpperCase, LowerCase, Number/SpecialChar and min 6 Chars." minlength="6" class="form-control" name="newPassword" required placeholder="Choose a safe one..">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="password" pattern="((?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$)"
                                title="UpperCase, LowerCase, Number/SpecialChar and min 6 Chars." minlength="6" class="form-control" name="confirmPassword" required placeholder="Confirm new password">
                            </div>
                        </div>
                        <div class="form-group row">
