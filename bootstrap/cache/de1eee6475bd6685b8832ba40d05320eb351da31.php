...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    <form action="/master/<?php echo e($master['id']); ?>/edit" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['name']); ?>" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['username']); ?>" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['phn_number']); ?>" type="tel" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['whatsapp_number']); ?>" type="tel" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['email']); ?>" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['address']); ?>" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['city']); ?>" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['state']); ?>" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="<?php echo e($master['pincode']); ?>" type="text" autocomplete="off" 
