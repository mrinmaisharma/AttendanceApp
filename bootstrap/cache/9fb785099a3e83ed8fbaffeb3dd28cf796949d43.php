                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="#" class="badge badge-pill badge-primary pull-right" data-toggle="modal" data-target="#view-batch<?php echo e($batch['id']); ?>" style="margin: 0.1rem 0;">View Details</a>
                        </div>
                        <div class="col-12">
                    ...
                    <!-- View Details Modal -->
                    <div class="modal fade" id="view-batch<?php echo e($batch['id']); ?>" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" style="color:inherit;"><strong><?php echo e($batch['name']); ?></strong></h5>
                                        ...
                                        <table class="table" style="background-color: transparent;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e(($batch['trainer'] == null) ? '--' : $batch['trainer']->name); ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <a href="/batch/<?php echo e($batch['id']); ?>/edit" class="btn btn-warning">Edit</a>
