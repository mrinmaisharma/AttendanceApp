...
@section('data-page-id', 'editStudent')
                ...
                <div class="card-body">
                    <form action="/student/{{$student['id']}}/edit" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="batch_id" id="batch" required>
                                    <option value="" {{($student!=null) ? 'selected': ''}}>Select Batch</option>
                                    @foreach(\App\Models\Batch::all() as $b)
                                        @if($student!=null)
                                            <option value="{{$b['id']}}" {{($b['id'] == $student['batch_id']) ? 'selected': ''}}>{{$b['name']}}</option>
                                        @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['name']}}" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['username']}}" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['phn_number']}}" type="tel" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['whatsapp_number']}}" type="tel" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['email']}}" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['institute']}}" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['address']}}" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['city']}}" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['state']}}" type="text" autocomplete="off" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{$student['pincode']}}" type="text" autocomplete="off" 
